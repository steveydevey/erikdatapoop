...
if ARGV[0].nil?
  puts 'tell me a file to use, idiot'
else
  workingfile = ARGV[0]
  ...
  if File.file?(workingfile) 
   ...
   # and include blanks when there are no datapoints
 #  15.times do |x|
 #    responses.each do |type|
 ...
 #
    ...
    #puts responses['First'] 
    #puts responses['Second']
    #puts responses['Third'] 
    #puts responses['Fourth']
    #puts responses['Fifth'] 
    #puts responses['Sixth']
    #puts responses['Seventh'] 	
    #puts responses['Eight'] 
    #puts responses['KeyPress1RT']
    #puts responses['KeyPress1RESP']
    #puts responses['KeyPress2RT'] 	
    #puts responses['KeyPress2RESP'] 
    #puts responses['KeyPress3RT']
    #puts responses['KeyPress3RESP']
    #puts responses['KeyPress4RT'] 
    #puts responses['KeyPress4RESP']
    #puts responses['KeyPress5RT'] 
    #puts responses['KeyPress5RESP']
    #puts responses['KeyPress6RT'] 
    #puts responses['KeyPress6RESP']
    #puts responses['KeyPress7RT'] 
    #puts responses['KeyPress7RESP']
    #puts responses['KeyPress8RT'] 
    #puts responses['KeyPress8RESP']
